...
export default function LoginScreen() {
  ...
  const validate = (): boolean => {
    ...
    if (!email.trim()) errors.email = 'E-posta gerekli';
    ...
    >
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.appName}>LiveApp</Text>
...
const styles = StyleSheet.create({
  ...
  inputWrapper: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: palette.dark3,
    borderRadius: radius.md,
    borderWidth: 1,
    borderColor: palette.dark4,
